...
-- Insert mode (escape first, then move)
--vim.keymap.set("i", "<C-Left>",  "<Esc><C-w>h")
--vim.keymap.set("i", "<C-Right>", "<Esc><C-w>l")
--vim.keymap.set("i", "<C-Up>",    "<Esc><C-w>k")
--vim.keymap.set("i", "<C-Down>",  "<Esc><C-w>j")
